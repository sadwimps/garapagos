...
def fncTactics():
    g_testlstPlace = g_lstPlaceStat
    sum = 0
    sumMIN = 9
    index = 0
    for i in range(len(g_testlstPlace)):
        g_testlstPlace[i] = g_testlstPlace[i] + 1           # 盤全てのステータスに+1をする
    
    print(g_testlstPlace)
